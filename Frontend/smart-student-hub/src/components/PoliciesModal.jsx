    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            {/* Modal Background */}
            <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-white/10 rounded-2xl shadow-2xl flex flex-col h-full">
              {/* Header */}
              <div className="relative bg-gradient-to-r from-slate-800 to-slate-900 border-b border-white/10 px-8 py-6 flex justify-between items-center">
              ...
              {/* Tabs */}
              <div className="flex gap-2 px-8 pt-6 border-b border-white/10 flex-wrap">
                {tabs.map(tab => (
                  <motion.button
                    key={tab.id}
                ...
                >
                    ...
                    <div className="space-y-6">
                      {privacyContent.map((section, index) => (
                        <motion.div
                          ...
                          className="bg-white/5 rounded-lg p-4 border border-white/10 hover:border-blue-500/30 transition-colors"
                        >
                  ...
                  {activeTab === "contact" && (
                    <div className="space-y-6">
                      ...
                      <div className="mb-8">
                        <h4 className="text-xl font-bold text-white mb-4">Contact Channels</h4>
                      ...
                      <div>
                        <h4 className="text-xl font-bold text-white mb-4">Our Team</h4>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          {contactContent.team.map((member, index) => (
                            <motion.div
                              ...
                              className="bg-white/5 rounded-lg p-4 border border-white/10 hover:border-white/30 transition-colors text-center"
                            >
              ...
              {/* Footer */}
              <div className="bg-slate-900/50 border-t border-white/10 px-8 py-4 flex justify-end">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={onClose}
                  className="px-6 py-2 bg-blue-500/20 text-blue-300 border border-blue-500/50 rounded-lg font-medium hover:bg-blue-500/30 transition-colors"
                >
                  Close
                </motion.button>
              </div>
